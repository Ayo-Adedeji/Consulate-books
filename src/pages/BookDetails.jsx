  ...
  return (
    <div className="mt-24 max-w-5xl mx-auto py-16 px-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
        <img src={book.cover} alt={book.title} className="w-full max-w-sm mx-auto rounded-xl shadow-lg object-cover" />
        <div>
          <h1 className="text-4xl font-bold leading-tight">{book.title}</h1>
          <p className="mt-3 text-lg text-gray-600">by <span className="font-medium">{book.author}</span></p>
